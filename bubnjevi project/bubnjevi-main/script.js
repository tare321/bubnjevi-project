...
window.addEventListener("keydown", (event) =>{                    //funkcija koja uzima sve tipke sa ekrana
 ...
 let audio = document.querySelector(`audio[data-key="${code}"]`);            //biranje audio zvuka
  audio.currentTime = 0;
 audio.play();
